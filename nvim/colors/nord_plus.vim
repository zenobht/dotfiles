...
let s:nord16_gui_bright = "#8690a3"
...
if !exists("g:nord_plus_bold")
  let g:nord_plus_bold = 1
endif

let s:bold = "bold,"
if g:nord_plus_bold == 0
  let s:bold = ""
endif

if !exists("g:nord_plus_italic")
  if has("gui_running") || $TERM_ITALICS == "true"
    let g:nord_plus_italic = 1
  else
    let g:nord_plus_italic = 0
  endif
endif

let s:italic = "italic,"
if g:nord_plus_italic == 0
  let s:italic = ""
endif

let s:underline = "underline,"
if ! get(g:, "nord_plus_underline", 1)
  let s:underline = "NONE,"
endif

let s:italicize_comments = ""
if exists("g:nord_plus_italic_comments")
  if g:nord_plus_italic_comments == 1
...
if !exists("g:nord_plus_bold_vertical_split_line")
  let g:nord_plus_bold_vertical_split_line = 0
endif
...
if g:nord_plus_bold_vertical_split_line == 0
...
call s:hi("Comment", s:nord16_gui_bright, "", s:nord3_term, "", s:italicize_comments, "")
...
call s:hi("Function", s:nord8_gui, "", s:nord8_term, "", s:italic, "")
...
call s:hi("SpecialComment", s:nord8_gui, "", s:nord3_term, "", s:italicize_comments, "")
