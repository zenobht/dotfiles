...
wk.add({
  ...
  { "<leader>bs", "<cmd>lua require('fzf-lua').lgrep_curbuf()<CR>", desc = "Search in buffer" },
  ...
  { "<leader>fw", "<cmd>lua require('fzf-lua').grep_cword()<CR>", desc = "Search string" },
  { "<leader>fy", ":let @+ = expand('%')<CR>", desc = "Yank current file path" },
  { "<leader>g", group = "git" },
  { "<leader>gC", "<cmd>lua require('fzf-lua').files({prompt='Conflicts>', cmd='git diff --name-only --diff-filter=U'})<CR>", desc = "Git Conflicts" },
  { "<leader>gL", "<cmd>lua require('keymap.utils').openTerm('tig')<CR>", desc = "Tig log" },
  { "<leader>gb", "<cmd>lua require('fzf-lua').git_bcommits()<CR>", desc = "Buffer Commits" },
  { "<leader>gB", "<cmd>lua require('fzf-lua').git_branches()<CR>", desc = "Branches" },
...
wk.add({
  ...
  { "<leader>fw", "<cmd>lua require('fzf-lua').grep_visual()<CR>", desc = "Search visual selection", mode = "v" },
})
