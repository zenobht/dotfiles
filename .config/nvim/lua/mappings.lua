...
api.nvim_set_keymap('n', 'sf', ":<C-U>call sneak#wrap('', 1, 0, 1, 2)<CR>", {})
api.nvim_set_keymap('n', 'sF', ":<C-U>call sneak#wrap('', 1, 1, 1, 2)<CR>", {})
api.nvim_set_keymap('n', 'st', ":<C-U>call sneak#wrap('', 1, 0, 0, 2)<CR>", {})
api.nvim_set_keymap('n', 'sT', ":<C-U>call sneak#wrap('', 1, 1, 0, 2)<CR>", {})
